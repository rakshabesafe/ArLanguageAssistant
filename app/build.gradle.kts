...
android {
    ...
    compileSdk = 33 // Updated to 33 as 31 might be too old for latest Android Studio
...
dependencies {
    ...
    implementation("com.google.ai.client.generativeai:generativeai:0.3.0") // Gemini AI
